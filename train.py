...
if __name__ == '__main__':
    ...
    model = RTDETR('/home/featurize/zfy/RTDETR-main/ultralytics/cfg/models/rt-detr/rtdetr-r18.yaml')
    # model.load('') # loading pretrain weights
    # model.train(data='/home/featurize/zfy/RTDETR-main/dataset/visdronedata.yaml', # 训练数据集的visdronedata文件路径
    model.train(data='/home/featurize/zfy/RTDETR-main/dataset/codronedata.yaml', # 训练数据集的simd文件路径
                cache=False,
                imgsz=640,
                epochs=300,
                ...
                # resume='/home/featurize/zfy/RTDETR-main/runs/train/exp29/weights/last.pt', # last.pt path
                project='runs/train',
                name='exp',
                )